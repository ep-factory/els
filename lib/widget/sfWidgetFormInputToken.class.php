...
EOF
  ...
  public function getJavaScripts() {
    return array_merge(parent::getJavaScripts(), array('jquery-tokeninput/jquery.tokeninput.js'));
  }

  public function getStylesheets() {
    return array_merge(parent::getStylesheets(), array('/js/jquery-tokeninput/token-input.css' => 'screen', '/js/jquery-tokeninput/token-input-facebook.css' => 'screen'));
  }
