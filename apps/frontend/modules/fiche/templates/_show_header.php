<div class="fiche_infos">
  ...
  <?php if($fiche->getIsFinished()): ?>
    <p><?php echo $fiche->getFinishedAuthor() ?> a clo(e) cette fiche le <?php echo format_date(strtotime($fiche->getFinishedDate()), "EEEE dd MMMM yyyy", "fr") ?> à <?php echo date('H\hi', strtotime($fiche->getFinishedDate())) ?></p>
  <?php endif ?>
</div>